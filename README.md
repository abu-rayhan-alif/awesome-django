...
- [django-security-hunter](https://github.com/abu-rayhan-alif/djangoSecurityHunter) - A CLI tool to find security vulnerabilities and performance misconfigurations in Django projects.
### Static Assets
